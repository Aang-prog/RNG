  ...
  return (
    <div className="App">
      <header className="App-header">
        <div className="Nav">
          <ul className='Menu'>
            ...
            <li className='MenuItem'>Potion</li>
            <li className='MenuItem'>NPC</li>
            <li className='MenuItem'>Encounter</li>
          </ul>
        </div>
      <h1 className="title">Random Item Generator</h1>
       ...
       <svg fill="#ffffff" width="150px" height="150px" viewBox="-16 0 512 512" xmlns="http://www.w3.org/2000/svg">
